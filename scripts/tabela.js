  ...
  indicarTema.innerText = tema + ", " + (palavras.length) + " words found";
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function criarLinha() {
      ...
      if (resultadoResposta == palavra) {
        textoTentativas.innerText = "You got it right in ";
        textoTentativas.appendChild(strong);
        textoTentativas.appendChild(document.createTextNode(" tries!"));
      } else if (numeroDeDivs == 6) {
        strong.textContent = palavra;
        textoTentativas.innerText = "The word was ";
        textoTentativas.appendChild(strong);
      } else {
        // Criar mais divs
